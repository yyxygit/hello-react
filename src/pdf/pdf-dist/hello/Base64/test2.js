...
import worker from '../../lib/pdf.worker.min.js';
 ...
 * 在src目录内拷入 pdf.worker.min.js 引入失败
 */
// debugger;
// pdfjs.GlobalWorkerOptions.workerSrc = worker;
// pdfjs.GlobalWorkerOptions.workerSrc = '/src/pdf/pdf-dist/lib/pdf.worker.min.js';
