 ...
 * @constructor
 */
const Search1 = ({ value, onChange, children, onSubmit }) =>
...
class Search extends Component {
    ...
    componentDidMount() {
        if(this.input.current) {
             ...
             */
            const inputEle = this.input.current;
            /**
             * this.input type DOM input element
             * <input type='text' value='redux-basic'>
             *     typeof this.input: object
             */
            console.log('this.input.current:', inputEle);
            // debugger;
            // object
            console.log('typeof this.input:', typeof this.input);


            /**
             * false
             */
            console.log('instanceof', this.input instanceof React.Component);

            /**
             * 似乎是调用原生的DOM API方法
             * 当应用程序渲染时，input 字段应该被聚焦。
             * 这就是 ref 属性的基本用法。
             */
            inputEle.focus();
        }
